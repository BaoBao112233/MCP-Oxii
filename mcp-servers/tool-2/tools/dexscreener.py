...
def convert_info_to_string(info):
    """
    Converts project information to string.

    Args:
        info (dict): Project information.

    Returns:
        str: Project information string.
    """
    try:
        # Lấy dữ liệu cơ bản
...
def convert_bundles_to_string(bundles_data, top_bundles=3):
    """
    Converts a list of bundles to a string.

    Args:
        bundles_data (dict): Dictionary containing information about bundles.
        top_bundles (int): Number of top bundles to display.

    Returns:
        str: String of the list of bundles.
    """
...
def get_contract_address_from_pairID(
    ...
    """
    Get information about a trading pair from Dexscreener API

    Args:
        pair_id (str): ID of the trading pair on base

    Returns:
        dict: Data about the trading pair or None if there is an error
    """
...
def get_bundle_token(
    ...
    Args:
        contract_address (str): Token contract address on base

    Returns:
        dict: Bundle data or error message
    """
...
def get_bubble_map_token(
    ...
    """
    Get bubble map token information from API.

    Args:
        contract_address (str): The contract address of the token.

    Returns:
        dict: The bubble map token data returned from API.
